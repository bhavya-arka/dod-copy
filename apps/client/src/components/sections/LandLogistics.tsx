    ...
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-foreground">Land Logistics</span>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {[
            { label: "Active Convoys", value: "0", icon: Truck, color: "text-accent" },
            { label: "In Transit", value: "0", icon: Route, color: "text-blue-500" },
            { label: "Delivered Today", value: "0", icon: Package, color: "text-green-500" },
