...
export const warehouseZones = pgTable("warehouse_zones", {
  ...
  usage_type: text("usage_type").default("general"),
...
export const warehouseItemMovements = pgTable("warehouse_item_movements", {
  ...
  weight_lbs: numeric("weight_lbs", { precision: 12, scale: 2 }),
  movement_type: text("movement_type").notNull().default("internal"), // internal, inbound, outbound, transfer, optimization
  movement_reason: text("movement_reason"), // optimization, transfer, receiving, shipping, reorganization
  source_type: text("source_type"), // optimization_plan, transfer_order, manual, import
